...
public class CheckItemsTotal {
    ...
    public void CheckItemsTotal() throws InterruptedException{
        ...
        String str = driver.findElement(By.className("summary_total_label")).getText();
             try{
                 Assert.assertTrue(str.equals("Total: $19.42"));
